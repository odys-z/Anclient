...
//			try
//			{
//				using (org.apache.commons.crypto.random.CryptoRandom random = org.apache.commons.crypto.random.CryptoRandomFactory
//					.getCryptoRandom(randomProperties))
//				{
//					random.nextBytes(iv);
//					return iv;
//				}
...
//			string encryptK)
//		{
//			byte[] iv = io.odysz.common.AESHelper.decode64(decryptIv);
...
//			return new string[] { b64, io.odysz.common.AESHelper.encode64(eiv) };
//		}
...
//		{
//			return Sharpen.Runtime.getBytesForString(input, java.nio.charset.StandardCharsets
//				.UTF_8);
//		}
