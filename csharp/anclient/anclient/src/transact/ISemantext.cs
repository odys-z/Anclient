...
namespace io.odysz.semantics
{
	...
	public interface ISemantext
	{
		...
		io.odysz.semantics.ISemantext connId(string conn);
		...
		io.odysz.semantics.ISemantext insert(io.odysz.transact.sql.Insert insert, string 
			mainTabl, params io.odysz.semantics.IUser[] usr);
		...
		io.odysz.semantics.ISemantext update(io.odysz.transact.sql.Update update, string 
			mainTabl, params io.odysz.semantics.IUser[] usr);

		/// <summary>
		/// Called each time an &lt;@link Insert} statement found itself will composing a insert-sql (
		/// <see cref="io.odysz.transact.sql.Insert.sql(ISemantext)"/>
		/// )<br />
		...
		io.odysz.semantics.ISemantext onInsert(io.odysz.transact.sql.Insert insert, string
			 tabl, System.Collections.Generic.IList<System.Collections.Generic.List<object[]
			>> rows);
		...
		/// <exception cref="SemanticException"></exception>
		/// <exception cref="io.odysz.transact.x.TransException"/>
		io.odysz.semantics.ISemantext onUpdate(io.odysz.transact.sql.Update update, string
			 tabl, System.Collections.Generic.List<object[]> nvs);

		/// <exception cref="io.odysz.transact.x.TransException"/>
		io.odysz.semantics.ISemantext onDelete(io.odysz.transact.sql.Delete delete, string
			 tabl, io.odysz.transact.sql.parts.condition.Condit whereCondt);
		...
		io.odysz.semantics.ISemantext onPost<_T0>(io.odysz.transact.sql.Statement<_T0> stmt
		...
		/// .
		/// </summary>
		io.odysz.semantics.SemanticObject resulves();
		...
		io.odysz.semantics.ISemantext clone(io.odysz.semantics.IUser usr);

		io.odysz.semantics.meta.TableMeta colType(string tabl);
		...
		void onCommitted(io.odysz.semantics.ISemantext ctx);
