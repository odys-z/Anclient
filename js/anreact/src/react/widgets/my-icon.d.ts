...
export function AvatarIcon(props?: {}): JSX.Element;
...
export const MyIcon: React.ComponentType<Pick<any, string | number | symbol> & import("@material-ui/core/styles").StyledComponentProps<"root">>;
export class MyIconComp extends React.Component<any, any, any> {
    constructor(props?: {});
    onClick(e: any): void;
    textInfo(ssInf: any): string;
}
export namespace MyIconComp {
