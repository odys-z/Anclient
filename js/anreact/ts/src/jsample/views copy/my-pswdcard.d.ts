export const MyPswd: React.ComponentType<Pick<PropTypes.InferProps<{}>, never> & import("@material-ui/core/styles").StyledComponentProps<"ok" | "notNull" | "maxLen" | "anyErr" | "minLen">>;
/**
