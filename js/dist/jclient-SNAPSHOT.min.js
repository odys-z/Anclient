...
const CheapCode = {
  ok: 'ok',
  err: 'wf_err',
  err_rights: 'wf_err_rights' ///////////////// io.odysz.sworkflow ///////////////////////////////////////////
...
/*!************************!*\
  !*** ./lib/jclient.js ***!
  \************************/
/*! exports provided: _J, J, SessionClient, Inseclient, Jregex, Protocol, JMessage, JHeader, UserReq, SessionReq, QueryReq, UpdateReq, DeleteReq, InsertReq, DatasetCfg, stree_t, CheapReq, chpEnumReq, CheapCode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class J {
  ...
  constructor(urlRoot) {
    ...
    aes = new _aes_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  }
  ...
  respCols(resp) {
    return resp !== null && resp !== undefined && resp.code === "ok" ? resp.data.rs[0][0] : [];
  }

  respRows(resp) {
    return resp !== null && resp !== undefined && resp.code === "ok" ? resp.data.rs[0].slice(1) : [];
  }
