...
class CheapReq {
  ...
  taskNv(n, v) {
    if (this.taskNvs === undefined || this.taskNvs === null) tthis.askNvs = [];
    this.taskNvs.push([n, v]);
    return this;
  }

  newChildInstRow() {
    if (this.childInserts === undefined || this.childInserts === null) this.childInserts = [];else this.childInserts.push([]);
  }
