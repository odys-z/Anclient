...
/*!************************!*\
  !*** ./lib/jclient.js ***!
  \************************/
/*! exports provided: _J, J, SessionClient, Inseclient, Protocol, JMessage, JHeader, SessionReq, QueryReq, UpdateReq, DeleteReq, DatasetCfg, CheapReq, chpEnumReq */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class SessionClient {
  ...
  insert(conn, maintbl, nvs) {
    if (this.currentAct === undefined || this.currentAct.func === undefined) console.error("jclient is designed to support user updating log natively, User action with function Id shouldn't ignored.", "To setup user's action information, call ssClient.usrAct().");
    var upd = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["UpdateReq"](conn, maintbl);
    upd.a = 'I';
...
/*!*************************!*\
  !*** ./lib/protocol.js ***!
  \*************************/
/*! exports provided: Protocol, JMessage, JHeader, SessionReq, QueryReq, UpdateReq, DeleteReq, DatasetCfg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class UpdateReq {
  ...
  nv(n, v) {
    if (Array.isArray(n)) this.nvs = this.nvs.concat(Protocol.nvs2arr(n));else this.nvs.push([n, v]);
    return this;
  }
