...
/******/ 	return __webpack_require__(__webpack_require__.s = "./lib/jclient.js");
/******/ })
/************************************************************************/
/******/ ({
...
function AES() {
  var verbose = false;
  var aesLib = new _opensources_ricmoo_aes_2_js__WEBPACK_IMPORTED_MODULE_0__["default"](window); // aesLib(window);
...
const CheapCode = {
  ...
  err_competation: 'wf_err_competing' ///////////////// io.odysz.sworkflow ///////////////////////////////////////////
...
class CheapReq {
  ...
  post(pst) {
    if (pst === undefined) {
      ...
      return this;
    } else if (typeof pst.version === 'string' && typeof pst.seq === 'number') console.warn('You pobably adding a JMessage as post operation? It should only be JBody(s).');
...
/*!************************!*\
  !*** ./lib/jclient.js ***!
  \************************/
/*! exports provided: _J, J, SessionClient, Inseclient, aes, Jregex, Protocol, JMessage, JHeader, UserReq, SessionReq, QueryReq, UpdateReq, DeleteReq, InsertReq, DatasetCfg, stree_t, CheapReq, chpEnumReq, CheapCode, CheapClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_J", function() { return _J; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "JMessage", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["JMessage"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "JHeader", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["JHeader"]; });
...
class J {
  ...
  constructor(urlRoot) {
    this.cfg = {
      connId: null,
      verbose: true,
      defaultServ: urlRoot // aes = new AES();
  ...
  login(usrId, pswd, onLogin, onError) {
    ...
    var iv = aes.getIv128();
    var c = aes.encrypt(usrId, pswd, iv); // var qobj = formatLogin(logId, c, bytesToB64(iv));
  ...
  post(jreq, onOk, onErr) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      error: function (resp) {
        if (typeof onErr === "function") onErr(_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].MsgCode.exIo, resp);else {
  ...
  respCols(resp, ix) {
    ...
    return resp !== null && resp !== undefined && resp.code === "ok" ? resp.data.rs[ix][0] : [];
  }
  ...
  respObjs(resp, start, len) {
    ...
    if (typeof start !== 'number') start = 1; // start from 0
    else start++;
    if (typeof len !== 'number') len = resp.data.rs[0].length - 1;else len = Math.min(len, resp.data.rs[0].length - start);
    var objs = [];

    for (var rx = start; rx < start + len; rx++) {
      var obj = {};

      for (var cx = 0; cx < cols.length; cx++) obj[cols[cx]] = resp.data.rs[0][rx][cx];
...
class SessionClient {
  ...
  setPswd(oldPswd, newPswd, opts) {
    ...
    var jmsg = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["JMessage"](_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port.session, this.getHeader(), body);
  ...
  query(conn, maintbl, alias, pageInf, act) {
    ...
    var header = _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].formatHeader(this.ssInf); // if (typeof act === 'object') {
    // 	header.act = act;
    ...
    var jreq = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["JMessage"](_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port.query, header, qryItem);
    return jreq;
  }
  ...
  userReq(conn, port, bodyItem, act) {
    ...
    return new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["JMessage"](port, header, bodyItem);
  }
...
/*!*************************!*\
  !*** ./lib/protocol.js ***!
  \*************************/
/*! exports provided: Jregex, Protocol, JMessage, JHeader, UserReq, SessionReq, QueryReq, UpdateReq, DeleteReq, InsertReq, DatasetCfg, stree_t */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JMessage", function() { return JMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JHeader", function() { return JHeader; });
...
class JMessage {
  constructor(port, header, body) {
    this.version = "1.0";
    this.seq = Math.round(Math.random() * 1000); // string options, like no-null: true for asking server replace null with ''.
    ...
    this.body = []; // this.body.push(body.parentMsg(this));
...
class QueryReq {
  constructor(conn, tabl, alias, pageInf) {
    this.conn = conn; // this.query = query;
  ...
  exprss(exps) {
    if (exps !== undefined && exps.length !== undefined) for (var ix = 0; ix < exps.length; ix++) if (exps[ix].exp !== undefined) this.expr(exps[ix].exp, exps[ix].as);else if (exps[ix].length !== undefined) this.expr(exps[ix][0], exps[ix][1]);else {
...
class DatasetCfg extends QueryReq {
  ...
  args(args) {
    if (this.sqlArgs === undefined) this.sqlArgs = [];
    if (typeof args === 'string') this.sqlArgs = this.sqlArgs.concat([args]);else if (Array.isArray(args)) this.sqlArgs = args;else console.error('sql args is not an arry: ', args);
...
//# sourceMappingURL=jclient-SNAPSHOT.min.js.map