...
function CheapClient(ssclient, cheaport) {
  this.connId = null;
  if (typeof cheaport === 'string') this.cheaport = cheaport;else this.cheaport = jvue.CheapReq.port;
  ...
  this.loadFlow = function (wfId, opts) {
    ...
    var cheapReq = new jvue.CheapReq(wfId).a(this.cheapReq.load).taskId(opts.taskId);
  ...
  this.loadCmds = function (wfId, opts) {
    ...
    var cheapReq = new jvue.CheapReq(wfId).a(this.cheapReq.nodeCmds).nodeId(opts.nodeId).usrId(opts.usrId).taskId(opts.taskId); // optional - not used
  ...
  this.start = function (cheapReq, opts) {
    ...
    var jmsg = this.jclient.userReq(this.connId, engports.cheapflow, cheapReq);
    this.jclient.commit(jmsg, opts.onok, function (c, d) {
      if (typeof opts.onerror === 'function') opts.onerror(c, d);else if (c === jvue.CheapCode.err_rights) EasyMsger.alert(EasyMsger.m.cheap_no_rights);else EasyMsger.error(c, d);
    });
    return this;
  };
  ...
  this.rights = function (wfid, taskId, currentNodeId, usrId, opts) {
    var req = new jvue.CheapReq(this.jclient, this.cheaport).a(this.cheapReq.load).arg('wfId', wfid).arg('taskId', taskId).arg('currentNode', currentNodeId).arg('usrId', usrId);
...
/* harmony import */ var _frames_cheapflow_cheap_client_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_frames_cheapflow_cheap_client_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _frames_cheapflow_cheap_client_js__WEBPACK_IMPORTED_MODULE_3__) if(["_J","J","SessionClient","Inseclient","aes","Jregex","Protocol","JMessage","JHeader","UserReq","SessionReq","QueryReq","UpdateReq","DeleteReq","InsertReq","DatasetCfg","stree_t","default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _frames_cheapflow_cheap_client_js__WEBPACK_IMPORTED_MODULE_3__[key]; }) }(__WEBPACK_IMPORT_KEY__));
