...
class J {
  ...
  servUrl(port) {
    ...
    console.log(_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port);
    console.log("Protocol.Port[" + port + "] : " + _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port[port]);
    if (_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port[port] !== undefined) return this.cfg.defaultServ + '/' + _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port[port] + '?conn=' + this.cfg.connId;else return this.cfg.defaultServ + '/' + port + '?conn=' + this.cfg.connId;
  }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      success: function (resp) {
        ...
        if (resp.code !== _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].MsgCode.ok) {
          if (typeof onErr === "function") onErr(_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].MsgCode.exIo, resp);else console.error(resp); // code == ok
