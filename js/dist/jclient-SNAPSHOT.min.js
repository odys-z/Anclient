...
/*!************************!*\
  !*** ./lib/jclient.js ***!
  \************************/
/*! exports provided: _J, J, SessionClient, Inseclient, Protocol, JMessage, JHeader, SessionReq, QueryReq, DatasetCfg, CheapReq, chpEnumReq */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class SessionClient {
  ...
  query(conn, t, alias, pageInf, act) {
    var qryItem = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["QueryReq"](conn, t, alias, pageInf);
    var header = _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].formatHeader(this.ssInf);
    if (typeof act === 'object') header.act = act;else header.userAct({
      func: 'query',
      cmd: 'select',
      cate: 'r',
  ...
  userReq(conn, t, port, bodyItem, act) {
    var header = _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].formatHeader(this.ssInf); // TODO make sure reading act can be null / undefined
  ...
  loadPage(query, pgSize, pgIx, onSuccess, onError) {
    if (typeof pgSize === "undefined") pgSize = -1;
    if (typeof pgIx === "undefined") pgIx = -1;
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      type: "POST",
      ...
      error: function (data) {
        if (typeof onError === "function") onError(data);else console.error(data);
      }
    });
  }
...
/*!*************************!*\
  !*** ./lib/protocol.js ***!
  \*************************/
/*! exports provided: Protocol, JMessage, JHeader, SessionReq, QueryReq, DatasetCfg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class QueryReq {
  ...
  wheres(conds) {
    if (conds !== undefined && conds.length !== undefined) for (var ix = 0; ix < conds.length; ix++) this.whereCond(conds[ix].op, conds[ix].l, conds[ix].r);
  }
