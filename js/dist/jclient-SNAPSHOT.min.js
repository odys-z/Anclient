...
class DatasetCfg extends QueryReq {
  ...
  sqlArgs(args) {
    ...
    if (typeof args === 'string') this.sqlArgs = this.sqlArgs.concat([args]);else if (Arry.isArray(sqlArgs)) req.sqlArgs = sqlArgs;else console.error('sql args is not an arry: ', sqlArgs);
