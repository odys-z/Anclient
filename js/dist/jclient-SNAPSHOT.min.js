...
/*!************************!*\
  !*** ./lib/jclient.js ***!
  \************************/
/*! exports provided: J, SessionClient, Inseclient, Protocol, JMessage, JHeader, SessionReq, QueryReq, DatasetCfg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class J {
  ...
  servUrl(port) {
    return this.cfg.defaultServ + '/' + _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port[port] + '?conn=' + this.cfg.connId;
  }

  init(connId, urlRoot) {
    this.cfg[connId] = urlRoot;
    if (this.cfg.defaultServ === null) this.cfg.defaultServ = urlRoot;
  }
