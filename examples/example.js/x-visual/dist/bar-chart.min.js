...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bar-chart/app.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "../../../../../../node_modules/anclient/lib/aes.js":
/*!**************************************************!*\
  !*** /home/ody/node_modules/anclient/lib/aes.js ***!
  \**************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "testAES", function() { return testAES; });
/* harmony import */ var _opensources_ricmoo_aes_2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./opensources/ricmoo-aes-2.js */ "../../../../../../node_modules/anclient/lib/opensources/ricmoo-aes-2.js");
/* ricomoo aes wrapper
 * Design notes:
...
function AES () {
	var verbose = false;
	var aesLib = new _opensources_ricmoo_aes_2_js__WEBPACK_IMPORTED_MODULE_0__["default"](window);
	// aesLib(window);
...
/***/ "../../../../../../node_modules/anclient/lib/anclient.js":
/*!*******************************************************!*\
  !*** /home/ody/node_modules/anclient/lib/anclient.js ***!
  \*******************************************************/
/*! exports provided: an, Jregex, Protocol, AnsonMsg, AnHeader, UserReq, SessionReq, QueryReq, UpdateReq, DeleteReq, InsertReq, AnsonResp, DatasetCfg, stree_t, CheapReq, chpEnumReq, CheapCode, CheapClient, AnClient, SessionClient, Inseclient, aes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _aes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./aes.js */ "../../../../../../node_modules/anclient/lib/aes.js");
/* harmony import */ var _protocol_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./protocol.js */ "../../../../../../node_modules/anclient/lib/protocol.js");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SessionReq", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["SessionReq"]; });
...
/* harmony import */ var _frames_cheapflow_cheap_req_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./frames/cheapflow/cheap-req.js */ "../../../../../../node_modules/anclient/lib/frames/cheapflow/cheap-req.js");
...
/* harmony import */ var _frames_cheapflow_cheap_client_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./frames/cheapflow/cheap-client.js */ "../../../../../../node_modules/anclient/lib/frames/cheapflow/cheap-client.js");
...
class AnClient {
	...
	servUrl (port) {
		...
		var ulr;
		if (_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port[port] !== undefined)
			ulr = this.cfg.defaultServ + '/'
				+ _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port[port]; // + '?conn=' + this.cfg.connId;
		else
			ulr = this.cfg.defaultServ + '/'
	...
	login (usrId, pswd, onLogin, onError) {
		...
		var req = _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].formatSessionLogin(usrId, c, aes.bytesToB64(iv));
	...
	post (jreq, onOk, onErr, ajaxOpts) {
		...
		var self = this;
		!(function webpackMissingModule() { var e = new Error("Cannot find module 'jquery'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).ajax({type: 'POST',
...
class SessionClient {
	...
	setPswd(oldPswd, newPswd, opts) {
		...
		var body = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["SessionReq"](usrId,
	...
	insert(conn, maintbl, nvs) {
		...
		var ins = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["InsertReq"](conn, maintbl);
	...
	delete(conn, maintbl, pk) {
		...
		var jmsg = this.userReq(conn,
				...
				_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port.update,
				upd, this.currentAct);
		return jmsg;
	}
...
/***/ "../../../../../../node_modules/anclient/lib/frames/cheapflow/cheap-client.js":
/*!****************************************************************************!*\
  !*** /home/ody/node_modules/anclient/lib/frames/cheapflow/cheap-client.js ***!
  \****************************************************************************/
...
/* harmony import */ var _cheap_req_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cheap-req.js */ "../../../../../../node_modules/anclient/lib/frames/cheapflow/cheap-req.js");
...
class CheapClient {
	constructor (ssclient, cheaport) {
		...
		else this.cheaport = _cheap_req_js__WEBPACK_IMPORTED_MODULE_0__["CheapReq"].port;
	...
	loadFlow (wfId, opts) {
		...
		var cheapReq = new _cheap_req_js__WEBPACK_IMPORTED_MODULE_0__["CheapReq"](wfId)
	...
	start (cheapReq, opts) {
		...
		this.jclient.commit(jmsg, opts.onok, function (c, d) {
			if (typeof opts.onerror === 'function')
				opts.onerror(c, d);
			else if (c === _cheap_req_js__WEBPACK_IMPORTED_MODULE_0__["CheapCode"].err_rights)
	...
	rights (wfid, taskId, currentNodeId, usrId, opts) {
		var req = new _cheap_req_js__WEBPACK_IMPORTED_MODULE_0__["CheapReq"](this.jclient, this.cheaport)
						.a(this.cheapReq.load)
						.arg('wfId', wfid)
						.arg('taskId', taskId)
...
/***/ "../../../../../../node_modules/anclient/lib/frames/cheapflow/cheap-req.js":
/*!*************************************************************************!*\
  !*** /home/ody/node_modules/anclient/lib/frames/cheapflow/cheap-req.js ***!
  \*************************************************************************/
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'jquery'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _protocol_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../protocol.js */ "../../../../../../node_modules/anclient/lib/protocol.js");
...
/***/ "../../../../../../node_modules/anclient/lib/opensources/ricmoo-aes-2.js":
/*!***********************************************************************!*\
  !*** /home/ody/node_modules/anclient/lib/opensources/ricmoo-aes-2.js ***!
  \***********************************************************************/
...
/***/ "../../../../../../node_modules/anclient/lib/protocol.js":
/*!*******************************************************!*\
  !*** /home/ody/node_modules/anclient/lib/protocol.js ***!
  \*******************************************************/
/*! exports provided: Jregex, Protocol, AnsonMsg, AnHeader, UserReq, SessionReq, QueryReq, UpdateReq, DeleteReq, InsertReq, AnsonResp, DatasetCfg, stree_t */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SessionReq", function() { return SessionReq; });
...
/* harmony import */ var anclient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! anclient */ "../../../../../../node_modules/anclient/lib/anclient.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module 'x-visual'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _bars__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bars */ "./bar-chart/bars.js");
/* harmony import */ var _lib_jvector__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../lib/jvector */ "./lib/jvector.js");
...
class App {
	constructor(canv) {
		...
		this.an = anclient__WEBPACK_IMPORTED_MODULE_0__["an"];
	...
	load() {
		...
		function reload (client) {
			...
			let jvector = new _lib_jvector__WEBPACK_IMPORTED_MODULE_3__["Jvector"](client);
		...
		function onError (code, resp) {
			if (code === anclient__WEBPACK_IMPORTED_MODULE_0__["Protocol"].MsgCode.exIo)
	...
	query() {
		let that = this;
		let req = this.ssClient.query(_lib_jvector__WEBPACK_IMPORTED_MODULE_3__["vec3conn"], "vector", "v");
		req.body[0]
		...
		this.an.post(req,
			...
			function(resp) {
				...
				const xworld = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'x-visual'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(c, window, {
					camera: {far: 10000} // default 5000
				});
				var ecs = xworld.xecs;

				xworld.addSystem('hello', // any group name as you like
					new _bars__WEBPACK_IMPORTED_MODULE_2__["default"](ecs, {xscene: xworld.xscene})
					.create(anclient__WEBPACK_IMPORTED_MODULE_0__["Protocol"].rs2arr(resp.body[0].rs[0])));
				xworld.startUpdate();
			});
	}
}
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'x-visual'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var anclient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! anclient */ "../../../../../../node_modules/anclient/lib/anclient.js");
 ...
 * @class
 */
class Bars extends !(function webpackMissingModule() { var e = new Error("Cannot find module 'x-visual'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
	...
	create(vectors) {
		for (let i = 0; i < vectors.length; i++) {
			...
			this.ecs.createEntity({
				id: v.vid,
				Obj3: { geom: !(function webpackMissingModule() { var e = new Error("Cannot find module 'x-visual'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).Obj3Type.BOX,
						box: [20, y, 20],
						transform: [ {translate: [i * 30 - 90, h, 0]} ]
					},
				Visual: {vtype: !(function webpackMissingModule() { var e = new Error("Cannot find module 'x-visual'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).mesh,
...
/*!************************!*\
  !*** ./lib/jvector.js ***!
  \************************/
/*! exports provided: vec3conn, examports, Jvector */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "vec3conn", function() { return vec3conn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "examports", function() { return examports; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Jvector", function() { return Jvector; });
/* harmony import */ var anclient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! anclient */ "../../../../../../node_modules/anclient/lib/anclient.js");


const vec3conn = "raw-vec";
...
class Jvector {
	...
	serv (a, onload) {
		let reqVec3 = new anclient__WEBPACK_IMPORTED_MODULE_0__["UserReq"](vec3conn)
			.a(a); // this is a reading request

		let header = anclient__WEBPACK_IMPORTED_MODULE_0__["Protocol"].formatHeader(this.ssInf);
		...
		var jreq = new anclient__WEBPACK_IMPORTED_MODULE_0__["AnsonMsg"](anclient__WEBPACK_IMPORTED_MODULE_0__["Protocol"].Port.vec3, header, reqVec3);
	...
	vectorsOf(respMsg) {
		...
		return anclient__WEBPACK_IMPORTED_MODULE_0__["Protocol"].rs2arr(respMsg.body[0].rs[0]);
	}
...
//# sourceMappingURL=bar-chart.min.js.map