(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["anreact"] = factory();
	else
		root["anreact"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./lib/anclient.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!********************!*\
  !*** ./lib/aes.js ***!
  \********************/
/*! exports provided: default, testAES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "testAES", function() { return testAES; });
/* harmony import */ var _opensources_ricmoo_aes_2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./opensources/ricmoo-aes-2.js */ "./lib/opensources/ricmoo-aes-2.js");
/* ricomoo aes wrapper
 * Design notes:
...
function AES() {
  var verbose = false;
  let hook = {};
  var aesLib = new _opensources_ricmoo_aes_2_js__WEBPACK_IMPORTED_MODULE_0__["default"](hook); // aesLib(window);
  ...
  this.encrypt = function (txt, key, iv) {
    ...
    var encryptedBytes = aesCbc.encrypt(textBytes); // check https://stackoverflow.com/questions/12710001/how-to-convert-uint8-array-to-base64-encoded-string
    // var encryptedB64  = btoa(String.fromCharCode.apply(null, encryptedBytes));

    var encryptedB64 = this.bytesToB64(encryptedBytes); // var u8_2 = new Uint8Array(atob(encryptedB64).split("").map(function(c) { return c.charCodeAt(0); }));

    return encryptedB64;
  };

  this.bytesToB64 = function (byteArr) {
    if (typeof btoa == 'function') return btoa(String.fromCharCode.apply(null, byteArr));else // should only happens in testing
      return Buffer.from(byteArr, 'binary').toString('base64');
  };

  this.b64ToBytes = function (b64Str) {
    return new Uint8Array((typeof atob === 'function' ? atob(b64Str) : Buffer.from(b64Str, 'base64').toString('binary')).split("").map(function (c) {
  ...
  this.decrypt = function (cipherB64, key, iv) {
    ...
    //   return c.charCodeAt(0); }));
    var encryptedBytes = this.b64ToBytes(cipherB64); // The cipher-block chaining mode of operation maintains internal
    // state, so to decrypt a new instance must be instantiated.

    var keyBytes = aesjs.utils.utf8.toBytes(key);
    var aesCbc = new aesjs.ModeOfOperation.cbc(keyBytes, iv);
    var decryptedBytes = aesCbc.decrypt(encryptedBytes); // Convert our bytes back into text
...
/*!*************************!*\
  !*** ./lib/anclient.js ***!
  \*************************/
/*! exports provided: an, Jregex, Protocol, AnsonMsg, AnHeader, UserReq, AnSessionReq, QueryReq, UpdateReq, DeleteReq, InsertReq, AnsonResp, DatasetCfg, stree_t, CheapReq, chpEnumReq, CheapCode, CheapClient, AnClient, SessionClient, Inseclient, aes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "an", function() { return an; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnClient", function() { return AnClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SessionClient", function() { return SessionClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Inseclient", function() { return Inseclient; });
...
/* harmony import */ var _aes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./aes.js */ "./lib/aes.js");
/* harmony import */ var _protocol_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./protocol.js */ "./lib/protocol.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Jregex", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Jregex"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Protocol", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AnsonMsg", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonMsg"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AnHeader", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnHeader"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UserReq", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["UserReq"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AnSessionReq", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnSessionReq"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "QueryReq", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["QueryReq"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UpdateReq", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["UpdateReq"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DeleteReq", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["DeleteReq"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "InsertReq", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["InsertReq"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AnsonResp", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonResp"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DatasetCfg", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["DatasetCfg"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "stree_t", function() { return _protocol_js__WEBPACK_IMPORTED_MODULE_2__["stree_t"]; });

/* harmony import */ var _frames_cheapflow_cheap_req_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./frames/cheapflow/cheap-req.js */ "./lib/frames/cheapflow/cheap-req.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CheapReq", function() { return _frames_cheapflow_cheap_req_js__WEBPACK_IMPORTED_MODULE_3__["CheapReq"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "chpEnumReq", function() { return _frames_cheapflow_cheap_req_js__WEBPACK_IMPORTED_MODULE_3__["chpEnumReq"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CheapCode", function() { return _frames_cheapflow_cheap_req_js__WEBPACK_IMPORTED_MODULE_3__["CheapCode"]; });

/* harmony import */ var _frames_cheapflow_cheap_client_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./frames/cheapflow/cheap-client.js */ "./lib/frames/cheapflow/cheap-client.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CheapClient", function() { return _frames_cheapflow_cheap_client_js__WEBPACK_IMPORTED_MODULE_4__["CheapClient"]; });
...
const aes = new _aes_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
class AnClient {
  ...
  understandPorts(newPorts) {
    ...
    _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].extend(newPorts);
    return this;
  }
  ...
  restReq(port, bodyItem) {
    let header = _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].formatHeader({});
    return new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonMsg"]({
      port,
      header,
      body: [bodyItem]
    });
  ...
  post(jreq, onOk, onErr, ajaxOpts) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      success: function (resp) {
        ...
        resp = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonMsg"](resp); // code != ok

        if (_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].verbose >= 5) {
      ...
      error: function (resp) {
        ...
        if (typeof onErr === "function") {
          if (resp.statusText) {
            resp.code = _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].MsgCode.exIo;
            resp.body = [{
              type: 'io.odysz.semantic.jprotocol.AnsonResp',
              m: 'Network failed: ' + resp.statusText
            }];
            onErr(_protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].MsgCode.exIo, new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonMsg"](resp));
          } else {
            if (resp.code || resp.port || !resp.status) resp = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonMsg"]({
              port: resp.port,
              header: resp.header,
              body: [{
                type: 'io.odysz.semantic.jprotocol.AnsonResp',
  ...
  static fromAjaxError(ajaxResp) {
    let json = {};
    json.code = _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].MsgCode.exIo;
    json.body = [{
      type: 'io.odysz.semantic.jprotocol.AnsonResp',
    ...
    return new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonMsg"](json);
  }
...
class SessionClient {
  ...
  setPswd(oldPswd, newPswd, opts) {
    ...
    var body = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnSessionReq"](usrId, tk, aes.bytesToB64(iv_tok)) //  tk and iv_tok shouldn't bee used
    .A('pswd').md('pswd', newPswd).md('iv_pswd', aes.bytesToB64(iv_new)).md('oldpswd', oldPswd).md('iv_old', aes.bytesToB64(iv_old));
    var jmsg = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonMsg"]({
      port: _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port.session,
  ...
  query(conn, maintbl, alias, pageInf, act) {
    ...
    var jreq = new _protocol_js__WEBPACK_IMPORTED_MODULE_2__["AnsonMsg"]({
      port: _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].Port.query,
      header,
      body: qryItem
    });
    return jreq;
  ...
  userReq(conn, port, bodyItem, act) {
    let header = _protocol_js__WEBPACK_IMPORTED_MODULE_2__["Protocol"].formatHeader(this.ssInf);
...
/***/ "./lib/frames/cheapflow/cheap-client.js":
/*!**********************************************!*\
  !*** ./lib/frames/cheapflow/cheap-client.js ***!
  \**********************************************/
/*! exports provided: CheapClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheapClient", function() { return CheapClient; });
/* harmony import */ var _cheap_req_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cheap-req.js */ "./lib/frames/cheapflow/cheap-req.js");
/* */
// import $ from 'jquery';
...
/***/ "./lib/frames/cheapflow/cheap-req.js":
/*!*******************************************!*\
  !*** ./lib/frames/cheapflow/cheap-req.js ***!
  \*******************************************/
/*! exports provided: CheapReq, chpEnumReq, CheapCode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheapReq", function() { return CheapReq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "chpEnumReq", function() { return chpEnumReq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheapCode", function() { return CheapCode; });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _protocol_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../protocol.js */ "./lib/protocol.js");
...
class CheapReq {
  constructor(wftype, port) {
    this.wftype = wftype;
    if (port === undefined) this.port = 'cheapflow.sample';else this.port = port;
  }
  /**set a.<br>
  ...
  arg(n, v) {
    if (v !== undefined) {
      // getting
      if (this.cmdArgs === undefined) this.cmdArgs = {}; // this.cmdArgs = Object.assign(this.cmdArgs, {n, v});

      this.cmdArgs[n] = v;
      return this;
    } else {
      if (this.cmdArgs === undefined) return; // for (var ix = 0; ix < this.cmdArgs.length; ix++) {
  ...
  taskNv(n, v) {
    if (this.taskNvs === undefined || this.taskNvs === null) this.taskNvs = [];
  ...
  post(pst) {
    if (pst === undefined) {
      ...
      return this;
    } else if (typeof pst.version === 'string' && typeof pst.seq === 'number') console.warn('You pobably adding a AnsonMsg as post operation? It should only be AnsonBody(s).');
...
/***/ "./lib/opensources/ricmoo-aes-2.js":
/*!*****************************************!*\
  !*** ./lib/opensources/ricmoo-aes-2.js ***!
  \*****************************************/
...
/*!*************************!*\
  !*** ./lib/protocol.js ***!
  \*************************/
/*! exports provided: Jregex, Protocol, AnsonMsg, AnHeader, UserReq, AnSessionReq, QueryReq, UpdateReq, DeleteReq, InsertReq, AnsonResp, DatasetCfg, stree_t */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Jregex", function() { return Jregex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Protocol", function() { return Protocol; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnsonMsg", function() { return AnsonMsg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnHeader", function() { return AnHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserReq", function() { return UserReq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnSessionReq", function() { return AnSessionReq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QueryReq", function() { return QueryReq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateReq", function() { return UpdateReq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeleteReq", function() { return DeleteReq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InsertReq", function() { return InsertReq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnsonResp", function() { return AnsonResp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DatasetCfg", function() { return DatasetCfg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stree_t", function() { return stree_t; });
...
class Protocol {
  ...
  static opts(options) {
    if (options) {
      ...
      Protocol.valOptions = Object.assign(Protocol.valOptions, options); // TODO we are planning extending verbose level requested by client.
...
class Jregex {
  ...
  static quote(str) {
    if (str === undefined || str === null) str = "''";else if (typeof str === "string" && str.substring(0, 1) !== "'" && str.substring(0, 2) != "''") return "'" + str + "'";
  }
...
class AnsonMsg {
  constructor(json) {
    if (typeof json !== 'object') throw new Error("AnClient is upgraded.");
    let header = json.header;
    let [body] = json.body ? json.body : [{}];
    if (body.type === 'io.odysz.semantic.jprotocol.AnsonResp') body = new AnsonResp(body);else if (body.type === 'io.odysz.semantic.jsession.AnSessionResp') body = new AnSessionResp(body);else if (body.type === 'io.odysz.semantic.jsession.AnSessionReq') body = new AnSessionReq(body.uid, body.token, body.iv);else {
      if (Protocol.verbose >= 5) console.warn("Using json object directly as body. Type : " + body.type);
    ...
    this.seq = json.seq;
    this.port = json.port; // this.version = "0.9";

    if (!this.seq) this.seq = Math.round(Math.random() * 1000); // string options, like no-null: true for asking server replace null with ''.

    this.opts = Protocol.valOptions; // moc the ajax error

    if (json.ajax) body.ajax = json.ajax;
    if (header) this.header = header;else this.header = {};
    this.body = [];
    if (body) body.parent = this.type;
    this.body.push(body);
  }
  ...
  post(pst) {
    if (this.body !== undefined && this.body.length > 0) return this.body[0].post(pst);
  }
...
class AnSessionReq extends AnsonBody {
  ...
  md(k, v) {
    if (this.mds === undefined) this.mds = {};
    this.mds[k] = v;
    return this;
  }
...
class QueryReq {
  constructor(conn, tabl, alias, pageInf) {
    ...
    this.joins = [];
    this.where = [];
    if (pageInf) this.page(pageInf.size, pageInf.page);
  }
  ...
  joinss(js) {
    if (js !== undefined && js.length !== undefined) for (var ix = 0; ix < js.length; ix++) this.join(js[ix].t, js[ix].tabl, js[ix].as, js[ix].on);
    return this;
  }
  ...
  exprss(exps) {
    if (exps !== undefined && exps.length !== undefined) {
      for (var ix = 0; ix < exps.length; ix++) {
        if (exps[ix].exp !== undefined) this.expr(exps[ix].exp, exps[ix].as);else if (exps[ix].length !== undefined) this.expr(exps[ix][0], exps[ix][1]);else {
          console.error(`Can not parse expr [exp, as]: exprs[${ix}] = `, exps[ix]);
        }
      }
    }
  ...
  whereCond(logic, loper, roper) {
    if (Array.isArray(logic)) this.where = this.where.concat(logic);else if (logic !== undefined) this.where.push([logic, loper, roper]);
    return this;
  }
  ...
  limit(expr1, expr2) {
    this.limt = [];
    if (expr1) this.limt.push(expr1);
    if (expr2) this.limt.push(expr2);
  }

  commit() {
    var hd = this.formatHeader(); // return { header: hd, tabls: froms, exprs: expr, conds: cond, orders: order, group: groupings};
...
class UpdateReq {
  ...
  constructor(conn, tabl, pk) {
    ...
    this.nvs = [];
    this.where = [];
    if (Array.isArray(pk)) this.where.push(pk);else if (typeof pk === "object") if (pk.pk !== undefined) this.where.push([pk.pk, pk.v]);else console.error("UpdateReq: Can't understand pk: ", pk);
  }
  /** add n-v
   * @param {string} n
   * @param {object} v
...
class InsertReq extends UpdateReq {
  ...
  valus(n_row, v) {
    if (this.nvss === undefined) this.nvss = [];
    var warned = false;
    ...
    if (Array.isArray(n_row)) {
      if (Array.isArray(n_row[0])) {
        ...
        if (Array.isArray(n_row[0][0]) && !warned) {
          console.warn('InsertReq is trying to handle multi rows in on value call, it is wrong. You must use InsertReq.nvRows(rows) instead.', n_row);
          warned = true;
        ...
        if (this.cols === undefined) this.columns(Protocol.nvs2cols(n_row));
    ...
    } else console.error('Error when setting n-v with', n_row, v, 'Check the type of n - only string for column, or n is an array represeting a row\'s n-vs!');
...
//# sourceMappingURL=anclient-0.9.27.min.js.map