...
//
//		ins.post(onDocreate(st, doc, SynodeMode.hub, meta, usr));
//
...
//	}
//
//	public static Update onDocreate(DATranscxt st, SyncDoc doc, SynodeMode mode, DocTableMeta meta, IUser usr)
//			throws TransException {
//
